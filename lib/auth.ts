...
export const ROLE_PERMISSIONS: Record<OrganizationRole, ReadonlySet<string>> = {
  owner: new Set(["*"]),
  admin: new Set(["position.manage", "candidate.read", "candidate.identity", "application.move", "application.delete", "assessment.run", "review.request", "reviewer.manage", "template.manage", "automation.manage", "audit.read", "team.manage", "email.send"]),
  recruiter: new Set(["position.manage", "candidate.read", "candidate.identity", "application.move", "application.delete", "assessment.run", "review.request", "reviewer.manage", "template.manage", "automation.manage", "audit.read", "email.send"]),
